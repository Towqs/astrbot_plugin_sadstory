...
重要：speaker 字段必须使用角色列表中的实际昵称，不要使用"主角A"、"主角B"、"{{protagonist_a}}"、"{{protagonist_b}}"等占位符。

示例（假设主角A是"{protagonist_a}"，主角B是"{protagonist_b}"，围观网友有"张三"）：
[
  {{"speaker": "{protagonist_a}", "content": "今天天气真好"}},
  {{"speaker": "{protagonist_b}", "content": "是啊，要不要一起出去走走"}},
  {{"speaker": "张三", "content": "你俩好甜啊"}},
  {{"speaker": "{protagonist_a}", "content": "哈哈哈"}}
]
